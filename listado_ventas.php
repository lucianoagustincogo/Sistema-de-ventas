...
<head>
    ...
    <title>Listado de ventas - ABM Clientes</title>
           ...
           <div class="col-12 card-body border ">
                <table class = "table table-hover">
                    ...
                    <tr>
                        ...
                        <td>
                        <a href="nueva_venta.php ?pos=<?php echo $pos;?>&do=insert"><i class="fas fa-edit"></i></a>
